...
def build_conv_layer(opts: dict, activation, name: str, logger, g_logger) -> Any:
    ...
    build_conv_layer.base_function = tf.keras.layers.Conv1D
    ...
    # try:
    #     conv_didimension = opts["dimension"]  # TOOD: shorthand 'dim'
    # except KeyError:
