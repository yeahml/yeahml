...
def eval_model(model: Any, main_cdict: dict, weights_path: str = None) -> dict:
    ...
    if weights_path:
        ...
        specified_path = main_cdict["save_weights_path"]
    ...
    # get datasets
    tfr_eval_path = os.path.join(main_cdict["TFR_dir"], main_cdict["TFR_train"])
    eval_ds = return_batched_iter("eval", main_cdict, tfr_eval_path)
