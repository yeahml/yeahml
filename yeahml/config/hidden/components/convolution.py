...
#             try:
#                 kernel_initializer = opts_raw["kernel_initializer"]
#             except KeyError:
#                 pass
#         elif opt == "bias_initializer":
#             try:
#                 bias_initializer = opts_raw["bias_initializer"]
#             except KeyError:
#                 pass
#         elif opt == "kernel_regularizer":
#             try:
#                 kernel_regularizer = opts_raw["kernel_regularizer"]
#             except KeyError:
#                 pass
#         elif opt == "bias_regularizer":
#             try:
#                 bias_regularizer = opts_raw["bias_regularizer"]
#             except KeyError:
#                 pass
#         elif opt == "activity_regularizer":
#             try:
#                 activity_regularizer = opts_raw["activity_regularizer"]
#             except KeyError:
#                 pass
#         elif opt == "kernel_constraint":
#             try:
#                 kernel_constraint = opts_raw["kernel_constraint"]
#             except KeyError:
#                 pass
#         elif opt == "bias_constraint":
#             try:
#                 bias_constraint = opts_raw["bias_constraint"]
#             except KeyError:
#                 pass
#         else:
...
#     try:
#         k_reg = get_regularizer_fn(kernel_initializer)
#     except KeyError:
#         k_reg = None
